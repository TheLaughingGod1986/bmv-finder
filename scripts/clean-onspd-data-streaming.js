...
/**
 * ONS Postcode Directory (ONSPD) Data Cleaning Script - Streaming Version
 ...
 *
 * Usage: node scripts/clean-onspd-data-streaming.js
 */
...
async function cleanONSPDDataStreaming() {
  try {
    console.log('🔄 Starting ONSPD data cleaning (streaming)...');
    ...
    for await (const line of rl) {
      ...
      try {
        ...
        if (lineCount === 1) {
          ...
          csvHeader = 'postcode,postcode_clean,x_coord,y_coord,latitude,longitude,object_id,introduction_date,termination_date,is_active,user_type,os_grid_reference,easting_1m,northing_1m,county,local_authority,ward,parish,constituency,health_authority,nhs_region,lsoa_2011,msoa_2011,lsoa_2021,msoa_2021,output_area_2011,output_area_2021,country,region,european_electoral_region,travel_to_work_area,urban_rural_2011,urban_rural_2021,built_up_area,national_park,imd_decile,global_id,created_at,updated_at';
...
module.exports = { cleanONSPDDataStreaming, cleanONSPDRecord };
