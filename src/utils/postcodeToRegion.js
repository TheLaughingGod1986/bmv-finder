...
function getPostcodeArea(postcode) {
  ...
  for (const prefix of Object.keys(POSTCODE_REGION_MAP)) {
    if (prefix.length === 2 && cleanPostcode.startsWith(prefix)) {
      return prefix;
    }
  }
...
// Export functions
export { postcodeToRegion, getAllRegions, getRegionCode, getRegionType, isValidPostcodeFormat, getPostcodeArea }; 