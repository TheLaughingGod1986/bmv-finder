...
export default function HeroSection({ className = '', onSearch }: HeroSectionProps) {
  ...
  return (
    <section className={`bg-gradient-to-b from-[#F5F5DC] to-[#E5E5E5] py-20 px-4 text-center ${className}`}>
      ...
      <p className="text-lg md:text-xl text-primary-green-dark mb-8 max-w-2xl mx-auto">
      ...
      {/* Sticky Search Bar */}
      <div className="sticky top-[64px] z-30 bg-neutral-100 py-4 shadow-md border-b border-neutral-200">
        <SearchInput 
      ...
      <div className="flex flex-wrap justify-center gap-6 mt-10 text-primary-blue-dark">
