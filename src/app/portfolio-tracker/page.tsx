...
export default function PortfolioTrackerPage() {
  ...
  const demoPortfolioData: PortfolioProperty[] = [
    ...
    {
      id: 'demo-4',
      address: '45 Riverside Court, Bristol',
      postcode: 'BS1 1AA',
    ...
    {
      id: 'demo-7',
      address: '34 Park Lane, Birmingham',
      postcode: 'B1 1DD',
